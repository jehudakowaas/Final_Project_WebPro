...
const Series = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.themoviedb.org/3/discover/tv?api_key=91a5c930ee76707444227ea8dc095130&language=en-US&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0')
  ...
  return(
    <section className="py-5">
      <div className="container px-4 px-lg-5 mt-5">
          ...
          { series.map(series => <SeriesItem key={series.id} series={series} />) }
